...
const vital_signRouter = express.Router();

vital_signRouter.post('/add', async (req: Request, res: Response) => {
...
vital_signRouter.put('/put', async (req: Request, res: Response) => {
...
vital_signRouter.get('/getOne', async (req: Request, res: Response) => {
...
vital_signRouter.delete('/delete', async (req: Request, res: Response) => {
  const id: string = req.query.id as string;
  const collection: RxCollection = db.vital_sings;
...
vital_signRouter.get('/getAll', async (req: Request, res: Response) => {
  const collection = db.vital_sings;
